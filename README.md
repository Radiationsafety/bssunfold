...
| 57 | `unfold_odl_pdhg` | Advanced proximal | `tau`, `sigma`, `use_tv`, `tv_weight`, `nonnegativity`, `tolerance` | odl | Primal-Dual Hybrid Gradient for L2+TV / L2+L2 problems via the ODL operator framework; TV preserves sharp spectral features |
| 58 | `unfold_odl_douglas_rachford` | Advanced proximal | `use_tv`, `tv_weight`, `nonnegativity`, `tolerance` | odl | Douglas-Rachford splitting for composite objectives (data fidelity + TV/L2 + non-negativity indicator) |
