...
class TestDetectorWithDictSpectrum:
    ...
    def test_get_effective_readings_with_dict_spectrum(
        self, detector, spectrum_dict
    ):
        """Тест расчета эффективных показаний для спектра в формате словаря"""
        # Вызов тестируемого метода
        eff_readings = detector.get_effective_readings_for_spectra(
            spectrum_dict
        )
