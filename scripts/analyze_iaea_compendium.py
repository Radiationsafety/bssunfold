...
Usage:
    python scripts/analyze_iaea_compendium.py
"""
...
OUTPUT_MD = TESTS_DIR / "IAEA_compendium_analysis.md"
PLOT_DIR = TESTS_DIR / "iaea_plots"
...
def run_analysis():
    csv_path = TESTS_DIR / "IAEA_Compendium_dataset.csv"
...
def generate_report(results: pd.DataFrame):
    ...
    a("**Date**: generated by `scripts/analyze_iaea_compendium.py`  ")
...
if __name__ == "__main__":
    ...
    # Save raw results
    results_path = TESTS_DIR / "IAEA_compendium_results.csv"
